...
<jsp:useBean id="sampleHelloWorldProxyid" scope="session" class="com.radha.HelloWorldProxy" />
<%
...
case 10:
        gotMethod = true;
        com.radha.HelloWorld getHelloWorld10mtemp = sampleHelloWorldProxyid.getHelloWorld();
