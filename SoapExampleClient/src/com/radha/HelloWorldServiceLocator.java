...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements com.radha.HelloWorldService {
    ...
    private java.lang.String HelloWorld_address = "http://localhost:6671/SoapExample/services/HelloWorld";
    ...
    public com.radha.HelloWorld getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.radha.HelloWorldSoapBindingStub _stub = new com.radha.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.radha.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                com.radha.HelloWorldSoapBindingStub _stub = new com.radha.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://radha.com", "HelloWorldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://radha.com", "HelloWorld"));
        }
